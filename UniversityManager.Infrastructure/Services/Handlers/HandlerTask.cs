...
namespace UniversityManager.Infrastructure.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<UniversityManagerException, Task> _onCustomErrorAsync;
        private Func<UniversityManagerException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<UniversityManagerException, Task> onCustomError,
        ...
        public IHandlerTask OnCustomError(Func<UniversityManagerException, Logger, Task> onCustomError,
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as UniversityManagerException;
